namespace geom {
    export class Matrix4x4 {
        ...
        public static RotationMatrixFromEulerAngles(angles: Vector3): Matrix4x4 {
            const A = angles.x;
            const B = angles.y;
            const Y = angles.z;

            const sA = trig.fxsin(A);
            const cA = trig.fxcos(A);
            const sB = trig.fxsin(B);
            const cB = trig.fxcos(B);
            const sY = trig.fxsin(Y);
            const cY = trig.fxcos(Y);
        ...
        public static RotationMatrixFromAxisAngle(axis: Vector3, angle: Fx8): Matrix4x4 {
            const O = angle;
            const s = trig.fxsin(O);
            const c = trig.fxcos(O);
        ...
        public static RotationMatrixFromAxisVectors(forward: Vector3, right: Vector3, up: Vector3): Matrix4x4 {
            return new Matrix4x4([
        ...
        public static ScalingMatrix(scale: number): Matrix4x4 {
            const s = Fx8(scale);
            return new Matrix4x4([
        ...
        public static NonUniformScalingMatrix(scale: Vector3): Matrix4x4 {
            return new Matrix4x4([
        ...
        public static MultiplyVector4(mat: Matrix4x4, vec4: Vector4): Vector4 {
        ...
        public static Multiply(matA: Matrix4x4, matB: Matrix4x4): Matrix4x4 {
        ...
        public static Transposed(mat: Matrix4x4): Matrix4x4 {
            const result = Matrix4x4.Zero();
